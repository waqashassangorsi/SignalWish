...
// Load info class.
if( ! in_array( 'di-blocks/di-blocks.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ){
	require_once LBROWSERC_PATH . 'inc/classes/class-lbrowserc-info.php';
	new Lbrowserc_Info();
}
