...
$receiptValue = "";
if(!empty($_REQUEST["ctransreceipt"]))
{
	$receiptValue = $_REQUEST["ctransreceipt"];
}
	...
	<table style="width:600px;">
		<tr>
			...
			<table cellspacing="5">
				...
				<tr>
					<td>Receipt ID</td>
					<td><input id="ctransreceipt" name="ctransreceipt" type="text" value="<?php echo $receiptValue; ?>" /></td>
				</tr>
			</table>
			</td>
		</tr>
