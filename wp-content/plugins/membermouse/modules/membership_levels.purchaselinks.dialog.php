...
?>
	...
	<p><strong>Purchase Link SmartTag</strong><?php echo MM_Utils::getInfoIcon("You can use this Purchase Link SmartTag in any post or page on your site. When using this SmartTag MemberMouse will automatically generate a link customers can click on to purchase this membership level."); ?></p>
	...
	<p><strong>Static Link</strong><?php echo MM_Utils::getInfoIcon("You can use this link anywhere -- in a PPC or banner ad, email, on your site, on a 3rd party site, etc. Customers can click on this link to purchase this membership level."); ?></p>
...
<div id="mm-form-container" style="width:460px;">
	...
	?>
		...
		<p>Purchase Link SmartTag<?php echo MM_Utils::getInfoIcon("You can use this Purchase Link SmartTag in any post or page on your site. When using this SmartTag MemberMouse will automatically generate a link customers can click on to sign up for this free membership level."); ?></p>
	
		<?php $smartTag = "<a href=\"[MM_Purchase_Link membershipId='{$p->accessTypeId}']\">Sign Up Now</a>"; ?>
		<input id="mm-smart-tag" type="text" readonly value="<?php echo htmlentities($smartTag,ENT_COMPAT | ENT_HTML401, "UTF-8"); ?>" style="width:440px; font-family:courier; font-size:11px;" onclick="jQuery('#mm-smart-tag').focus(); jQuery('#mm-smart-tag').select();" />	
		
		<p>Static Link<?php echo MM_Utils::getInfoIcon("You can use this link anywhere -- in a PPC or banner ad, email, on your site, on a 3rd party site, etc. Customers can click on this link to sign up for this free membership level."); ?></p>
		
		<input id="mm-static-link" type="text" readonly value="<?php echo htmlentities(MM_CorePageEngine::getCheckoutPageStaticLink($p->accessTypeId, true),ENT_COMPAT | ENT_HTML401, "UTF-8"); ?>" style="width:440px; font-family:courier; font-size:11px;" onclick="jQuery('#mm-static-link').focus(); jQuery('#mm-static-link').select();" />
	<?php } ?>
	</div>
</div>