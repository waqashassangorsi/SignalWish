	...
	class BSF_AIOSRS_Pro_Setup_Wizard {
		...
		public function welcome() {
			...
			if ( '' !== $branding_msg['sp_plugin_name'] ) {
				...
				<p class="success">
					<?php esc_html_e( 'Schema Pro adds JSON-LD markups across your website and on specific pages that improve SEO.', 'wp-schema-pro' ); ?>
				</p>
				<?php
			}
			?>
			<p class="success no-margin">
				<?php esc_html_e( 'Here is what we\'re going to do in the next few steps:', 'wp-schema-pro' ); ?>
			</p>
			<ul>
				<li><?php esc_html_e( 'Implement Schema for the entire website. Ex: Breadcrumb, SiteLinks, Social Profiles, etc.', 'wp-schema-pro' ); ?></li>
				<li><?php esc_html_e( 'Setup specific Schema for individual pages. Ex: Services, Products, Reviews, Recipes, etc.', 'wp-schema-pro' ); ?></li>
			</ul>
			<p class="success">
				<?php esc_html_e( 'Now, let\'s proceed with implementing Schema for the entire website.', 'wp-schema-pro' ); ?>
			</p>
